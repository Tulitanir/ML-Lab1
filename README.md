...
В качестве функции потерь используется кросс-энтропия, оптимизатор — AdamW с L2-регуляризацией (`weight_decay=1e-4`), расписание скорости обучения — косинусное затухание.
